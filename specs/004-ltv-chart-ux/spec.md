...
- **短期貸款圖表呈現**：當貸款年限 ≤5 年時，圖表以每年為單位取樣（而非每 5 年），確保至少有 3-5 個資料點呈現趨勢變化
...
- **FR-003**: 系統必須在還款趨勢圖中以年為單位進行資料取樣，長期貸款（>5年）間隔為 5 年，短期貸款（≤5年）間隔為 1 年
...
- Q: 當貸款年限少於 5 年時，還款趨勢圖的取樣間隔應該如何處理？ → A: 短期貸款（≤5年）以每年取樣，長期貸款維持每 5 年取樣
